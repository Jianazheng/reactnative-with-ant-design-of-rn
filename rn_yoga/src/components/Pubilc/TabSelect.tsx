              ...
              tabs.map((val, i) => {
                return (
                  <View style={[styles.tabItem, mainStyle.aiCenter, mainStyle.jcCenter]} key={i}>
                    <TouchableOpacity style={[mainStyle.flex1, mainStyle.aiCenter, mainStyle.jcCenter, styles.info, i == tabIndex ? mainStyle.bgcju : null, mainStyle.palr10, mainStyle.patb5]}
                      onPressIn={() => {
