...
let imgw = (screenW-setSize(80))*0.4;
    ...
    return (
      ...
      onPress={()=>{
        ...
        <View style={[mainStyle.bgcfff,mainStyle.pa15,mainStyle.row,mainStyle.jcBetween]}>
          <Image
          style={[{width:imgw,height:imgw},mainStyle.bgcc2,{borderRadius:setSize(8)}]}
          mode="widthFix" 
          source={{uri:'http://'+(data.image.constructor==Array?data.image[0]:'')}}
          >
          </Image>
          <View style={[mainStyle.column,mainStyle.mal15,mainStyle.flex1,mainStyle.jcBetween]}>
            ...
            <View style={[mainStyle.row]}>
              <Text style={[mainStyle.pa5_10,mainStyle.bgcf2,mainStyle.c333,{borderRadius:setSize(4)}]}>{data.lesson}课时</Text>
            </View>
